                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">                            
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:scale-105 rounded-lg shadow-2xl p-3">
                            ...
                            <h4 className="font-semibold my-4 text-lg md:text-2xl text-center mb-4 h-12">DeepFake detection Pipeline</h4>
                                ...
                                <p className="text-md font-medium leading-5 h-auto md:h-48">
                                    Whenever any content is uploaded to any social media platform, RF AI’s deepfake detection pipeline will realiably categorize AI generated content. The said social media platform will then have a much easier time developing an action plan for the generative AI content on their platform. 
                                    ...
                                    There is a lot of untapped value in social media content with respect to training data for deepfake detection. 
                                    {/* The goal is to reach a point where we can have inference fast enough to just add the result of our deepfake detection pipeline to the metadata of the content. */}
                                </p>
                                <div className="flex justify-center my-4">
                                    <Link to="/get-demo" className="text-white bg-blue-900 hover:bg-blue-800 inline-flex items-center justify-center w-full px-6 py-3 my-4 text-lg shadow-xl rounded-xl">
                                        Demo (beta)
