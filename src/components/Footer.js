                ...
                <div className="footer max-w-full mx-auto px-4 sm:px-6 bg-gray-100 border-t border-b py-30">
                    ...
                    <div className="col-span-12 lg:col-span-4">
                        <div className="box-border border-b-4 border-blue-900 p-8 bg-gray-200 text-gray-600 text-center rounded-lg xl:w-80 mx-auto">
                            <h3 className="font-bold text-4xl mb-4">RF AI</h3>
                    ...
                    <div className="col-span-6 md:col-span-6 lg:col-span-1 ml-7 mx-auto">
                        ...
                        <li className="mb-2">
                            <HashLink to="/#portfolio" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Services</HashLink>
                        </li>
                        <li className="mb-2">
                    ...
                    <div className="col-span-6 md:col-span-6 lg:col-span-4 mx-auto">
                        ...
                        <ul className="text-md">
                        <li className="mb-2">
                            <Link to="/contact#contact" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">DeepFake Detection Pipeline</Link>
                        </li>
                        {/* <li className="mb-2">
                    ...
                    <div className="col-span-12 text-center mx-auto lg:col-span-3 font-bold uppercase text-blue-900">
                        ...
                        <div className="mx-auto text-center mt-2">
                                <ul className="flex justify-center mb-4 md:mb-0">
                                    <li> <a className="flex justify-center items-center text-blue-900 hover:text-gray-500 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out"href="https://www.linkedin.com/in/gopalk-shukla/" target="_blank" rel="noreferrer"> </a></li>
                                    {/* <li>
