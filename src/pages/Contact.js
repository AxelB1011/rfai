...
const Contact = () => {
    // const form = useRef();
    useDocTitle('RF AI | Send us a message')
    ...
    const sendEmail = (e) => {
        ...
        //         'Access-Control-Allow-Origin': 'http://localhost:5001/contact'
        //     }
        // })
                ...
                <form onSubmit={sendEmail}>
                    ...
                    <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                        ...
                        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 mt-5">
                                <div>
                                    {/* <input type="hidden" name="access_key" value="9e115c1d-da4a-461e-abaf-750bcad34fa5"/> */}
                                    <input 
                                        name="first_name" 
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <p className="text-gray-400">Tel: (813)970-4966</p>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <a href="https://www.linkedin.com/in/gopalk-shukla/" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8  mx-1 text-center pt-1">
